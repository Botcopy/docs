...
Upon clicking the “Grant” button, the emails addresses will receive an email that contains a link to Portal.

### Deleting Users

To delete a user from an organization, click the three dot button on the user's row and select “Delete User” from the menu that appears. A modal will open to confirm the deletion. Once a user is deleted, they are eligible to be invite to another organization.
