...
## Scope of Work
Botcopy provides an open endpoint for you to connect an ITSM Tool like Genesys, Service Now, HP SM, etc. It is your responsibility to create the proxy between the ITSM tool and Botcopy's endpoint.
